...
class Profile(BaseModel):
    ...
    def get_cart_count(self):
        return CartItems.objects.filter(cart__is_paid = False , cart__user = self.user).count()  # We can pass this count by passing context 
...
# Create Signals To execute Profile Class
